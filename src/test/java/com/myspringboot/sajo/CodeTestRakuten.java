...
import com.myspringboot.sajo.cart.ProductDto;
import com.myspringboot.sajo.cart.ProductDto2;
import com.myspringboot.sajo.cart.TranslationService;

@SpringBootTest
public class CodeTestRakuten {
	
	@Autowired
    private TranslationService tSvc;

    @Test
    public void rakutenCrawlAndTranslateTest() {
        ...
        tSvc.checkUsage();
        try {
            String url = "https://books.rakuten.co.jp/rb/15588084/"; 
            driver.get(url);
            ...
            WebElement titleElement = wait.until(
        	    ExpectedConditions.presenceOfElementLocated(By.xpath("(//h1)[3]"))
        	);
